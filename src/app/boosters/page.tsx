...
const totalPrice = boosters.reduce((sum, b) => sum + b.originalPrice, 0);
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed inset-0 z-[9999] bg-[#0d1317] overflow-y-auto"
      >
                  ...
                  <div className="p-5 pb-3">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-white/60 text-sm font-medium">SMS</span>
                      </div>
                      ...
                      <div className="text-right">
                        {booster.comingSoon ? (
                          <div className="flex items-center gap-2">
                            <span className="text-white/40 text-sm line-through">${booster.originalPrice}</span>
                            <span className="text-white text-sm font-bold">${booster.price}</span>
                    ...
                    <h3 className="text-lg font-bold !text-white mb-1">{booster.title}</h3>
                  ...
                  >
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-white/70 text-sm font-medium">Voir la démo</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
              ...
              <div className="flex items-start">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="px-2.5 py-1 bg-white/10 text-white text-xs font-bold rounded">
                      -50%
                    </span>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <div className="flex items-center gap-3 flex-wrap">
                      ...
                      <span className="text-sm text-white/60">par mois · sans engagement</span>
                    </div>
                    
                    <button
                      onClick={() => {
                        console.log('Purchase pack');
                      }}
          ...
          <div className="pt-6 border-t border-white/10">
            <div className="flex items-center justify-center gap-3">
              ...
              <p className="text-white/70 text-sm">
                <span className="font-bold text-white">+2,400</span> étudiants ont déjà décollé avec nous
              </p>
            </div>
          </div>
        </div>
