...
export function BoostersWidget({ floating = true }: BoostersWidgetProps) {
  ...
  if (!floating) {
    return (
      <>
        {/* Bouton Mastery Boosters - Style identique à DocumentUploadWidget */}
        <motion.div
        ...
        {/* Modal Boosters - Light Mode Grid 2x2 */}
        <AnimatePresence>
          {showModal && (
            <motion.div
              initial={{ opacity: 0 }}
                    ...
                    {boosters.map((booster, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Visual Preview */}
                          <div className="relative h-36 bg-gradient-to-br from-gray-100 to-gray-200 mx-4 mb-4 rounded-xl overflow-hidden group-hover:from-gray-200 group-hover:to-gray-300 transition-colors">
