...
export const mockCourses: Course[] = [
  ...
  // Cours Analyse Mathématique I
  {
    ...
    price: 700,
    previewAvailable: true,
    previewDuration: '8 min',
    tags: ['mathématiques', 'analyse', 'dérivées'],
    difficulty: 'intermediate',
    packId: 'pack-mathematiques'
  },
  // Cours Mécanique Classique
  {
    id: 'course-physique-mecanique',
    title: 'Mécanique Classique',
    description: 'Principes de la mécanique newtonienne et applications pratiques',
    faculty: 'Solvay Brussels School',
    year: 'Première année',
    totalLessons: 22,
    completedLessons: 0,
    ...
    price: 700,
    previewAvailable: true,
    previewDuration: '9 min',
    tags: ['physique', 'mécanique', 'newton'],
    difficulty: 'intermediate',
    packId: 'pack-sciences'
  },
  // Cours Chimie Générale
  {
    ...
    previewAvailable: true,
    previewDuration: '8 min',
    tags: ['chimie', 'atomes', 'molécules'],
    difficulty: 'intermediate',
    packId: 'pack-sciences'
  },
  // Cours supplémentaires pour enrichir la section
  {
    id: 'course-thermodynamique',
    title: 'Thermodynamique',
    description: 'Lois de la thermodynamique et applications énergétiques',
    faculty: 'Solvay Brussels School',
    year: 'Première année',
    totalLessons: 16,
    completedLessons: 0,
    ...
    previewAvailable: true,
    previewDuration: '7 min',
    tags: ['physique', 'thermodynamique', 'énergie'],
    difficulty: 'intermediate'
  },
  {
    id: 'course-algebre-lineaire',
    title: 'Algèbre Linéaire',
    description: 'Matrices, espaces vectoriels et transformations linéaires',
    faculty: 'Solvay Brussels School',
    year: 'Première année',
    totalLessons: 24,
    completedLessons: 0,
    ...
    previewAvailable: true,
    previewDuration: '8 min',
    tags: ['mathématiques', 'algèbre', 'matrices'],
    difficulty: 'advanced'
  },
  {
    id: 'course-optique',
    title: 'Optique Géométrique',
    description: 'Lois de l\'optique, lentilles et instruments optiques',
    faculty: 'Solvay Brussels School',
    year: 'Première année',
    totalLessons: 14,
    completedLessons: 0,
    ...
    previewAvailable: true,
    previewDuration: '6 min',
    tags: ['physique', 'optique', 'lumière'],
    difficulty: 'intermediate'
  },
  {
    id: 'course-chimie-organique',
    title: 'Chimie Organique',
    description: 'Composés carbonés, réactions et mécanismes organiques',
    faculty: 'Solvay Brussels School',
    year: 'Deuxième année',
    totalLessons: 28,
    completedLessons: 0,
    ...
    tags: ['chimie', 'organique', 'carbone'],
    difficulty: 'advanced'
  },
  {
    id: 'course-statistiques',
    title: 'Statistiques Descriptives',
    description: 'Analyse de données, probabilités et tests statistiques',
    faculty: 'Solvay Brussels School',
    year: 'Première année',
    totalLessons: 18,
    completedLessons: 0,
    ...
    previewAvailable: true,
    previewDuration: '7 min',
    tags: ['mathématiques', 'statistiques', 'probabilités'],
    difficulty: 'intermediate'
  },
  {
    id: 'course-biologie-cellulaire',
    title: 'Biologie Cellulaire',
    description: 'Structure et fonctions des cellules vivantes',
    faculty: 'Solvay Brussels School',
    year: 'Première année',
    totalLessons: 22,
    completedLessons: 0,
    ...
    previewAvailable: true,
    previewDuration: '8 min',
    tags: ['biologie', 'cellules', 'organismes'],
    difficulty: 'intermediate'
  },
  {
    id: 'course-electromagnetisme',
    title: 'Électromagnétisme',
    description: 'Champs électriques et magnétiques, équations de Maxwell',
    faculty: 'Solvay Brussels School',
    year: 'Deuxième année',
    totalLessons: 26,
    completedLessons: 0,
    ...
    previewAvailable: true,
    previewDuration: '9 min',
    tags: ['physique', 'électromagnétisme', 'maxwell'],
    difficulty: 'advanced'
  },
  {
    id: 'course-geometrie-analytique',
    title: 'Géométrie Analytique',
    description: 'Géométrie dans le plan et l\'espace, coordonnées et vecteurs',
    faculty: 'Solvay Brussels School',
    year: 'Première année',
    totalLessons: 16,
    completedLessons: 0,
    ...
    previewAvailable: true,
    previewDuration: '7 min',
    tags: ['mathématiques', 'géométrie', 'vecteurs'],
    difficulty: 'intermediate'
  }
];
...
export const mockSuggestions: CourseSuggestion[] = [
  ...
  // Nouveaux cours pour enrichir le catalogue
  {
    course: mockCourses.find(c => c.id === 'course-math-analyse-1')!,
    reason: 'prerequisite',
  ...
  {
    course: mockCourses.find(c => c.id === 'course-physique-mecanique')!,
    reason: 'faculty_popular',
  ...
  {
    course: mockCourses.find(c => c.id === 'course-chimie-generale')!,
    reason: 'similar_students',
  ...
  {
    course: mockCourses.find(c => c.id === 'course-thermodynamique')!,
    reason: 'continuation',
    enrolledStudents: 98,
    averageProgress: 29,
    isPopular: false,
  ...
  {
    course: mockCourses.find(c => c.id === 'course-algebre-lineaire')!,
    reason: 'prerequisite',
  ...
  {
    course: mockCourses.find(c => c.id === 'course-optique')!,
    reason: 'similar_students',
    enrolledStudents: 76,
    averageProgress: 33,
    isPopular: false,
  ...
  {
    course: mockCourses.find(c => c.id === 'course-chimie-organique')!,
    reason: 'faculty_popular',
  ...
  {
    course: mockCourses.find(c => c.id === 'course-statistiques')!,
    reason: 'prerequisite',
  ...
  {
    course: mockCourses.find(c => c.id === 'course-biologie-cellulaire')!,
    reason: 'similar_students',
    enrolledStudents: 89,
    averageProgress: 36,
    isPopular: false,
  ...
  {
    course: mockCourses.find(c => c.id === 'course-electromagnetisme')!,
    reason: 'continuation',
    enrolledStudents: 67,
    averageProgress: 31,
    isPopular: true,
  ...
  {
    course: mockCourses.find(c => c.id === 'course-geometrie-analytique')!,
    reason: 'prerequisite',
...
export function generateUpsellOptions(lessonId: string, courseId?: string): PurchaseOption[] {
  ...
  // Features de base (leçon)
  const lessonFeatures = [
    'Vidéos FullHD',
    'Quiz d\'auto-évaluation'
  ];

  // Features du cours (tout ce de la leçon + extras)
  const fullCourseFeatures = courseFeatures.concat([
    'Vidéos FullHD',
    'Quiz d\'auto-évaluation',
  ...
  // Features du pack (TOUT du cours + extras premium) - TOUTES LES FEATURES INCLUSES
  ...
  // Construire un itemId spécifique au cours pour la leçon
  const lessonItemId = courseId && lessonId 
    ? `${courseId}-${lessonId}` 
    : lessonId;
  ...
  const options: PurchaseOption[] = [
    ...
    // Option 1: Pack complet (meilleur investissement) - TOUT INCLUS
    {
      type: 'pack',
      itemId: packId,
      title: packTitle,
...
export const mockCircles: Circle[] = [
  ...
  // Communautés par pays
  {
    ...
    name: 'Belgique',
    type: 'faculty',
    description: 'Tous les étudiants de Belgique - Partage et entraide',
    memberCount: 523,
    icon: '🇧🇪',
    color: 'blue',
    isJoined: true,
  ...
  },
  {
    ...
    name: 'France',
    type: 'faculty',
    description: 'Communauté des étudiants de France',
    memberCount: 892,
    icon: '🇫🇷',
    color: 'blue',
    isJoined: false,
  ...
  },
  {
    ...
    name: 'Maroc',
    type: 'faculty',
    description: 'Réseau des étudiants du Maroc',
    memberCount: 456,
    icon: '🇲🇦',
    color: 'red',
    isJoined: false,
  ...
  // Communautés par ville
  {
    id: 'brussels-city',
    name: 'SMS Bruxelles',
    type: 'faculty',
    description: 'Étudiants de Bruxelles - Meetups et événements locaux',
    memberCount: 345,
    icon: '🏙️',
    color: 'indigo',
    isJoined: true,
  ...
  },
  {
    ...
    name: 'SMS Paris',
    type: 'faculty',
    description: 'Communauté parisienne - Rencontres et révisions',
    memberCount: 412,
    icon: '🗼',
    color: 'pink',
    isJoined: false,
  ...
  },
  {
    ...
    name: 'SMS Lyon',
    type: 'faculty',
    description: 'Étudiants lyonnais - Entraide et networking',
    memberCount: 178,
    icon: '🦁',
    color: 'orange',
    isJoined: false,
  ...
  },
  {
    ...
    name: 'SMS Casablanca',
    type: 'faculty',
    description: 'Communauté de Casablanca - Partage et collaboration',
    memberCount: 234,
    icon: '🕌',
    color: 'teal',
    isJoined: false,
  ...
  },
  {
    ...
    name: 'SMS Rabat',
    type: 'faculty',
    description: 'Étudiants de Rabat - Sessions d\'étude et événements',
    memberCount: 156,
    icon: '🏛️',
    color: 'green',
    isJoined: false,
